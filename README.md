...
| PCA 設定 | 平均執行時間 | 相較於 PCA-100 |
| --- | ---: | ---: |
| PCA-100 | 4.21 秒 | — |
| PCA-154 | 5.66 秒 | +1.45 秒（+34.5%） |
...
| 比較項目 | PCA-100 | PCA-154 | 差異 |
| --- | ---: | ---: | ---: |
| 主成分數量 | 100 | 154 | +54 |
| 平均執行時間 | 4.21 秒 | 5.66 秒 | +1.45 秒（+34.5%） |
| 累積解釋變異比 | 91.43% | 94.98% | +3.55 個百分點 |
...
Perplexity = 50 時，相較於 Perplexity = 30，執行時間增加約 8.7%

Perplexity = 100 時，相較於 Perplexity = 30，執行時間增加約 14.5%
...
| Perplexity | 執行時間 | KL Divergence | 二維分布 |
| --- | ---: | ---: | --- |
| 30 | 1823.56 秒 | 2.69791 | 類別群聚明顯 |
| 50 | 1981.94 秒 | 2.50825 | 與 30 相近 |
| 100 | 2087.64 秒 | 2.22970 | 部分類別出現較明顯混雜 |
...
| --- | --- |
| 30 | 10 個數字類別皆形成明顯群聚 |
| 50 | 與 Perplexity = 30 相近 |
| 100 | 4 與 9 的區域出現較明顯的樣本混雜 |
...
| 資料載入 | 11.31 秒 | 約 0.9% |
| 資料前處理 | 0.46 秒 | 約 0.04% |
| PCA-100 | 9.46 秒 | 約 0.8% |
| t-SNE | 1176.63 秒 | 約 98.2% |
...
| t-SNE 輸出維度 | 2 維 |
| t-SNE 迭代次數 | 999 |
| t-SNE 執行時間 | 1176.63 秒 |
| 最終 KL Divergence | 2.67494 |
